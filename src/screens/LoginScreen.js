...
const styles = StyleSheet.create({
  ...
  usernameWrap:  { flexDirection: 'row', alignItems: 'center', borderWidth: 1.5, borderColor: '#E8E8E2', borderRadius: 12, backgroundColor: '#FAFAF7', marginBottom: 6 },
  usernameAt:    { paddingLeft: 14, fontSize: 15, color: '#8A8A82', fontWeight: '600' },
  usernameInput: { flex: 1, padding: 14, paddingLeft: 6, fontSize: 15, color: '#1A1A18' },
  hint:          { fontSize: 11, color: '#B0AFA8', marginBottom: 16 },
  forgotWrap:    { alignItems: 'flex-end', marginTop: -8, marginBottom: 16 },
  forgotText:    { fontSize: 13, color: '#D94F3D', fontWeight: '500' },
